<?php
// source: C:\Program Files (x86)\Ampps\www\astro\app/config/config.neon 
// source: C:\Program Files (x86)\Ampps\www\astro\app/config/config.local.neon 

class Container_8432fc211d extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
			...
			'App\Presenters\astroPresenter' => [1 => ['application.1']],
		...
		'services' => [
			...
			'application.1' => 'App\Presenters\astroPresenter',
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			'appDir' => 'C:\Program Files (x86)\Ampps\www\astro\app',
			'wwwDir' => 'C:\Program Files (x86)\Ampps\www\astro\www',
			'debugMode' => true,
			'productionMode' => false,
			'consoleMode' => false,
			'tempDir' => 'C:\Program Files (x86)\Ampps\www\astro\app/../temp',
		];
	}
	...
	/**
	 * @return App\Presenters\astroPresenter
	 */
	public function createServiceApplication__1()
	{
		$service = new App\Presenters\astroPresenter;
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, 'C:\Program Files (x86)\Ampps\www\astro\app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\SQLiteJournal('C:\Program Files (x86)\Ampps\www\astro\app/../temp/cache/journal.s3db');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('C:\Program Files (x86)\Ampps\www\astro\app/../temp/cache',
	...
	{
		return new Container_8432fc211d_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
...
class Container_8432fc211d_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_8432fc211d $container)
	{
	...
	public function create()
	{
		...
		$service->setTempDirectory('C:\Program Files (x86)\Ampps\www\astro\app/../temp/cache/latte');
